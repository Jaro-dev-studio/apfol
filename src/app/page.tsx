  ...
  return (
    <div className="bg-[#f5f0e8] text-[#1d1d1f] overflow-hidden">
            ...
            >
              <div className="relative aspect-square max-w-lg mx-auto lg:mx-0">
                ...
                <div className="absolute inset-0 z-10">
                  <ScrollRotate3DModel
                    modelPath="/models/mac_watch_stand.glb"
                ...
                {/* Interaction hint */}
                <div className="absolute -bottom-2 sm:bottom-4 left-1/2 -translate-x-1/2 text-xs text-[#1d1d1f]/40 pointer-events-none">
                  Drag to rotate
                </div>
              </div>
            </motion.div>
            ...
            <div className="order-2">
              ...
              >
                ...
                <p className="text-[#1d1d1f]/70 leading-relaxed">
                  The Watchintosh transforms daily charging into a conversation starter. It's not just a stand, it's a 1984 icon reimagined for {new Date().getFullYear()}, precision-crafted to make your Apple Watch look like the tiny computer it really is. It's a statement piece that sparks joy and starts conversations.
                </p>
      ...
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 z-40 bg-[#f5f0e8]/95 backdrop-blur-lg border-t border-[#d4cdc0] p-4 sm:hidden safe-area-bottom"
      >
